...
const generatorMaxUpgrades = {};
  ...
  const generatorConfig = {
    ...
    // Tier 2
    diamond:   { tier: 2, baseCost: new BigNumber("25000"),  power: () => 5000 + generatorUpgrades.diamond.level * 5000, key: "generatorsDiamond", label: "Diamond Generators", button: "generateDiamond", span: "generatorsDiamond", max: defaultGameData.generatorMax.diamond, upgrade: "upgradeDiamond", sell: "sellDiamond", maxBtn: "maxDiamond" },
    platinum:  { tier: 2, baseCost: new BigNumber("125000"),  power: () => 25000 + generatorUpgrades.platinum.level * 8000, key: "generatorsPlatinum", label: "Platinum Generators", button: "generatePlatinum", span: "generatorsPlatinum", max: defaultGameData.generatorMax.platinum, upgrade: "upgradePlatinum", sell: "sellPlatinum", maxBtn: "maxPlatinum" },
    uranium:   { tier: 2, baseCost: new BigNumber("500000"),  power: () => 100000 + generatorUpgrades.uranium.level * 20000, key: "generatorsUranium", label: "Uranium Generators", button: "generateUranium", span: "generatorsUranium", max: defaultGameData.generatorMax.uranium, upgrade: "upgradeUranium", sell: "sellUranium", maxBtn: "maxUranium" },
    sapphire:  { tier: 2, baseCost: new BigNumber("2500000"),  power: () => 500000 + generatorUpgrades.sapphire.level * 40000, key: "generatorsSapphire", label: "Sapphire Generators", button: "generateSapphire", span: "generatorsSapphire", max: defaultGameData.generatorMax.sapphire, upgrade: "upgradeSapphire", sell: "sellSapphire", maxBtn: "maxSapphire" },
    obsidian:  { tier: 2, baseCost: new BigNumber("10000000"),  power: () => 2000000 + generatorUpgrades.obsidian.level * 80000, key: "generatorsObsidian", label: "Obsidian Generators", button: "generateObsidian", span: "generatorsObsidian", max: defaultGameData.generatorMax.obsidian, upgrade: "upgradeObsidian", sell: "sellObsidian", maxBtn: "maxObsidian" },
    // Tier 3
